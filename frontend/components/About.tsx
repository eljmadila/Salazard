      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="mt-8">
              <div className="font-heading italic text-4xl text-white opacity-90 mb-2">Alexandre Dubois</div>
              <p className="text-gray-400 font-heading text-xl mt-2">Executive Chef</p>
            </div>
          </motion.div>
        </div>
      </div>
