    ...
    <div className="flex flex-col flex-1 bg-black pt-32 pb-24">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full mb-32">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          ...
          >
            <img 
              src="https://images.unsplash.com/photo-1514362545857-3bc16c4c7d1b?q=80&w=1074&auto=format&fit=crop" 
      ...
      <section className="bg-[#0a0a0a] py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            ...
            >
              <img 
                src="https://images.unsplash.com/photo-1577219491135-ce391730fb2c?q=80&w=1284&auto=format&fit=crop" 
                alt="Executive Chef"
                className="object-cover w-full h-full"
              />
            </motion.div>
            ...
            >
              ...
              <div className="font-heading italic text-5xl text-white opacity-90">Alexandre Dubois</div>
            </motion.div>
          </div>
        </div>
      </section>
